...
from sqlalchemy import Column, Date, DateTime, Float, ForeignKey, Text
...
class MaintenanceLog(Base):
    ...
    photos = relationship(
        "MaintenancePhoto", back_populates="log", cascade="all, delete-orphan"
    )
    comments = relationship(
        "MaintenanceComment", back_populates="log", cascade="all, delete-orphan"
    )
